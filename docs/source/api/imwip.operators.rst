...
:code:`x @ M`. The matrix :code:`M` can be obtained explicitly, using the :py:mod:`~imwip.matrices.matrices` module.

This module provide Scipy LinearOperators which are equivalent to the matrix representation,
